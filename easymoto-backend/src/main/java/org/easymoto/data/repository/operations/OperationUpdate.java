...
@Data
@Transactional
@Component(OperationUpdate.COMPONENT_NAME)
public class OperationUpdate implements OperationStrategy {

	public static final String COMPONENT_NAME = "OperationUpdate";
